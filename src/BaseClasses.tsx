...
export namespace BaseClasses {
    ...
    abstract class QuestionView<P extends QuestionViewProps> extends Viewable<QuestionViewProps> {
        attempts: number;
    ...
    interface QuestionViewProps extends RX.CommonProps {
        onanswer: Function,
        question: Question,
        [key: string]: any
    }
